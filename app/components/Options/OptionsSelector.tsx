...
const OptionsSelector = ({ selectedAction }: { selectedAction: OptionsTransaction }) => {
    const basePrice = 100;
    ...
    return (
        <div className="w-full flex flex-col gap-y-4 max-h-[500px] overflow-y-scroll hide-scrollbar">
            {prices.map((priceBlock, priceIndex) => (
                <div key={priceIndex}>
                    ...
                    {priceBlock.data.map((option, optionIndex) => (
